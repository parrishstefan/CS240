...
g++ -c -m64 -Wall -fno-pie -no-pie -l good-moring.lis -o good_morning.o good_morning.cpp -std=c++14

echo "Link the two 'O' files good_morning.o hello.o"
g++ -m64 -fno-pie -no-pie -std=c+14 -o good.out good_morning.o hello.o 
